"""Decipher a path through a Union Route Cipher.
...
Arrows show encryption route; for negatice key values read UP.
...
Required inputs - a text message, # of colums, # of rows, key string
